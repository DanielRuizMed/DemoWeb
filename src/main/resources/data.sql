...
insert into usuario (username, nombre, password, rol_id)
	select 'user1', 'Daniel Ruiz', '$2a$10$5xOe75pbLcAjp0TbVWaluunrSshgYdH82YNwGd.b0Os4hAWbIEkry', 1 from dual where not exists (select 1 from usuario where username = 'user1');
